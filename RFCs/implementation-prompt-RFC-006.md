# Implementation Prompt for RFC-006: Data Management & n8n Worker Local
...
## Context
This implementation covers RFC-006, which focuses on Data Management & n8n Worker Local. Please refer to the following documents:
...
- @RFC-006-Data-Worker.md for the specific requirements being implemented
...
## Scope Limitation
Please only implement the features specified in @RFC-006-Data-Worker.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
