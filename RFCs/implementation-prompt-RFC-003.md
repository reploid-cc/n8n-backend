# Implementation Prompt for RFC-003: n8n Backend Local Service
...
## Context
This implementation covers RFC-003, which focuses on n8n Backend Local Service. Please refer to the following documents:
...
- @RFC-003-n8n-Backend-Local.md for the specific requirements being implemented
...
## Scope Limitation
Please only implement the features specified in @RFC-003-n8n-Backend-Local.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
